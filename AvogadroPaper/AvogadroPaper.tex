...
released under an open source license. Licensing costs can be prohibitive. If
...
extensible framework is needed in order to perform innovative research. The
creation of a framework that implements many of the necessary foundations for a
