...
necessary for an advanced semantically-aware editor at a later time by looking for
new features of the standard while still remaining readable in older versions.

Through the use of Open Babel a large array of file formats can be interpreted,
and a big portion of the work in doing this has been done by the Open Babel
...
library called OpenQube. More recently a large amount of work has been done
...
can highlight simple typing errors in keywords, as well as harder to spot whitespace
errors that would otherwise cause the hand edited input deck to fail when being
read by GAMESS-US. Some early stage additions to the GAMESS plugin even allow
for the submission of GAMESS-US jobs to computational clusters.

\subsection{Parsing and Visualization of Quantum Code Output}
...
development, for Avogadro version 2.0.

% More on Future Development here
