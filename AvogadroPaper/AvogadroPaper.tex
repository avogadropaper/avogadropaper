...
The Avogadro project is an advanced molecule editor and visualizer
...
chemical data types. The work presented here details the Avogadro library, which provides a framework,
...
been translated into over 20 languages,\cite{Translations} and over 20 contributors.\cite{OhlohContributors}
...
has been written using the API made available to plugin writers, and is loaded
...
is presented. Simply left clicking on the black part of the display
...
Keyboard shortcuts are also available to change the active element (by typing
the one or two letter symbol), or bond order (by entering the numeric bond
order).
...
GRH and DC are the founders of the Avogadro project.
