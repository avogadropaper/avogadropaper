...
\title{Avogadro: An Advanced Chemical Editing, Visualizing, and
  Analysis Platform}
...
Pittsburgh, PA, 15260, USA\\
  ...
  \iid(3)Department of Computer Science, Coe College, 1220 First Avenue NE, Cedar Rapids, Iowa 52402\\
  \iid(4)Department of Chemistry, State University of New York at Buffalo, Buffalo, New York 14260-3000\\
...
\textbf{Background:} The Avogadro project is an advanced molecule editor and visualizer
...
document type, Avogadro seeks to enhance the semantic accesibility of
chemical data types.

\textbf{Results:} The work presented here details the Avogadro library, which provides a framework,
...
\textbf{Conclusions:} It is freely available under an open-source license from http://avogadro.openmolecules.net.
...
work on the most common operating systems (GNU/Linux, Apple Mac OS X, Windows, and
BSD).
...
them only run on Microsoft Windows), and are not easily extensible, customized, or
integrated into automated workflows. Licensing costs can be prohibitive. If
the developer were to change its direction or focus this can lead to a loss of
...
creation of such a framework that implements many of the necessary foundations for a
...
computational packages (i.e., GAMESS-US for MacMolPlt). Whilst offering many interesting and
...
easy extension to new features and specialized areas.

The Avogadro project was started in earnest in 2007, and over the
first 5 years of development has been downloaded over 250,000 times,\cite{Downloads}
been translated into over 20 languages,\cite{Translations} and over 20
...
along with several less common features. It is very easy for new users to install Avogadro and build their
...
\begin{figure}
  ...
  \end{center}
  \caption{The Avogadro graphical user interface (on Mac OS X), showing the editing interface
for a molecule.}
  \label{f:avogadrogui}
\end{figure}
...
is presented. By default, the draw tool is selected. Simply left clicking on the black part of the display
...
primary focus rendering graphics to the screen. As is the case with most
...
University of Pittsburgh for support.
